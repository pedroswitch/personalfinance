...
public class InvoiceRegistrationTest
{
    ...
    {
        // Act
        InvoiceRegistration invoice = new InvoiceRegistration(id, date, supplier, number, category, value, status);
    ...
    void shouldBeSameAs()
    {
        ...
        InvoiceRegistration invoice2 = new InvoiceRegistration(id2, date2, supplier2, number2, category2, value2, status2);
        InvoiceRegistration invoice = new InvoiceRegistration(id, date, supplier, number, category, value, status);
